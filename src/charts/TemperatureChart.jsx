...
const TemperatureChart = () => {
    ...
    const values = dataDict.map(valuesData => valuesData.temperature)
    ...
    const option = {
        tooltip: {
            ...
            formatter: function (params) {
              ...
              params.forEach((item) => {
                tooltipContent += `<div>
                  <span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:${"rgb(0, 255, 242 )"};"></span>
