...
const SoilMoistureChartB = () => {
  ...
  const values = chartData.map((item) => item.values['soil-moisture']);
  ...
  const option = {
    ...
    series: [
      {
        name: 'Soil Temperature', // You might want to rename it to 'Soil Moisture'
        type: 'line',
        smooth: false,
        lineStyle: {
          color: 'rgb(255, 186, 67)',
          width: 2,
        },
        showSymbol: false,
        symbol: 'circle',
...
export default SoilMoistureChartB;
